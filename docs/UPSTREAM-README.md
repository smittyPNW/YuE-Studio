> Archived upstream README from Tony Weston’s YuE Studio at commit `907563b170b53c14f6b1065b249b6c5ecebc6777`. Its release/install claims describe upstream, not this public edition. Start with the [current README](../README.md).
...
[docs/apple-silicon.md](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/docs/apple-silicon.md).
...
<p align="center">
  <img src="https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/assets/logo.png" alt="YuE" width="150" />
</p>

<p align="center">
  <picture>
    <source media="(max-width: 600px)" srcset="https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/assets/institutions-mobile.svg" />
    <img src="https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/assets/institutions.svg" alt="HKUST, M·A·P, Tokenwave.AI, NYU, Stanford, MBZUAI, NOIZ, and ACE Studio" width="760" />
  </picture>
</p>
...
[![YuE2 song quality and text alignment on WildSongBench](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/assets/frontier-teaser.png)](https://map-yue2.github.io/#model-overview)

*192 WildSongBench prompts. Both YuE2 settings use symbolic planning. Bo8 = best-of-8. The axes are normalized comparison indices; bubble area represents AudioBox production quality. [Scores and evaluation protocol](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/docs/benchmarks.md). [Vector PDF](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/assets/frontier-teaser.pdf) · [SVG](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/assets/frontier-teaser.svg).*
...
![YuE2 architecture: style and lyrics become an editable score, semantic music tokens, acoustic latents, and audio](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/assets/architecture.png)
...
The staged Python API exposes `plan()` → `generate_semantic()` → `synthesize()` → `decode()`. See the [generation guide](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/docs/generation.md) for exact-plan reuse and decoder selection.
...
[Generation guide](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/docs/generation.md) · [Original example inputs](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/examples/README.md) · [v0.1.6 wheel archive](https://github.com/multimodal-art-projection/YuE/releases/download/yue2-v0.1.6/yue2_infer-0.1.6-py3-none-any.whl)
...
SheetSage2 runs in a separate environment and loads its MERT2 encoder automatically. The [cover guide](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/docs/covers.md) gives the complete transcription and generation commands. An included [original melody example](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/examples/melody.abc) also lets you try score-conditioned generation immediately.
...
The editable score is the white-box interface: you can inspect the intended composition and intervene on it. Editing generates a new complete recording; it does not preserve the original waveform outside an edit. [Editing guide and a reproducible harmony example](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/docs/editing.md).

## Agent skill

The **[yue2-music skill](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/skills/yue2-music/SKILL.md)** teaches an agent how to generate songs, transcribe and cover recordings, edit ABC scores, check musical invariants, and organize listening comparisons. It includes portable helpers and references to the released model interfaces.
...
YuE2's first-party code, agent skill, and documentation are licensed under **[Apache 2.0](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/LICENSE)**. Copyright (c) 2026 the YuE2 authors.

Model weights are separately licensed under **[CC BY-NC 4.0](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/MODEL_LICENSE)**. Third-party components retain their [original licenses](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/THIRD_PARTY_NOTICES.md). The archived [YuE-v1 branch](https://github.com/multimodal-art-projection/YuE/tree/YuE-v1) retains its original license.
...
For collaborations, licensing, and data partnerships, please contact [gezhang@umich.edu](https://github.com/tonywestonuk/YuE-Studio/blob/907563b170b53c14f6b1065b249b6c5ecebc6777/mailto:gezhang@umich.edu).
